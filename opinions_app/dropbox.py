...
# в документации метода [create_shared_link_with_settings()]
...
# Синхронная версия функции загрузки изображений и получения на них ссылок.
# import requests
